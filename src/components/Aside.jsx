...
function Aside() {
  ...
  return (
    <aside className='group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-white border-t bg-[#121212] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] lg:sticky lg:max-w-[250px]'>
                ...
                <li key={item.route} className={item.className + "/20"}>
                    <NavLink
                       ...
                       className={({isActive}) => 
                        ...
                        flex flex-col items-center justify-center border-white py-1 focus:text-[#ae7aff] sm:w-full sm:flex-row sm:border sm:p-1.5 sm:hover:bg-[#ae7aff] sm:hover:text-white sm:focus:border-[#ae7aff] sm:focus:by-[#ae7aff] sm:focus:text-black sm:group-hover:justify-start sm:group-hover:px-4 lg:justify-start lg:px-4`
                       }
                    >
