...
import { publishVideo, updateVideo } from '../../store/slices/videoSlice';
import { createPortal } from 'react-dom';
import UploadingVideo from './UploadingVideo';
import UploadSuccess from './UploadSuccess';

function UploadVideo({ video = false }, ref) {
    const dialog = useRef();
  ...
  return (
    <div>
        {showPopup &&
          createPortal(
            <dialog ref={dialog} className='h-fit backdrop:backdrop-blur-lg lg:w-[40%] md:w-2/3'>
              <UploadingVideo 
                ref={uploadingDialog}
                abort={handleAbort}
                    ...
                    <div className='mx-auto flex w-full max-w-3xl flex-col gap-y-2 md:gap-y-3 p-4'>
                            ...
                            <>
                              <div className='w-full border-2 border-dashed px-2 py-5 text-center'>
                                ...
                                <p className='text-gray-400 text-sm md:text:lg'>
                                    Your videos will be public until you unpublish them
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button
                              ...
                              className="bg-[#ae7aff] px-4 py-2 md:px-4 md:py-3 text-black hover:font-semibold hover:border disabled:bg-[#E4D3FF] disabled:cursor-not-allowed"
                            >
