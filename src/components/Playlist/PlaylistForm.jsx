...
import { createPlaylist, updatePlaylist } from '../../store/slices/playlistSlice';
                ...
                <div className='relative flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]'>
                    <div className='fixed inset-0 top-[calc(66px)] z-10 flex flex-col bg-black/50 px-4 pb-[86px] pt-4 sm:top-[calc(82px)] sm:px-14 sm:py-8'>
                      <form 
                        ...
                        className='mx-auto w-full max-w-lg overflow-auto rounded-lg border border-x-gray-700 text-white bg-[#121212] p-4'
                      >
                        {/* Header */}
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <button 
                              type='button'
                              onClick={() => dialog.current.close()}
                              className='border px-4 py-3 hover:bg-[#212121FF] hover:border-dotted border-white'
                            >
                                Cancel
                            </button>
                            <button
                              ...
                              className='bg-[#ae7aff] hover:bg-[#ae7aff]/90 hover:border-dotted border-white border px-4 py-3 text-black disabled:bg-[#E4D3FF] disabled:cursor-not-allowed'
                            >
