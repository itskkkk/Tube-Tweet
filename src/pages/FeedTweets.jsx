...
import { createTweet, getAllTweets } from '../store/slices/tweetSlice';
import { toast } from 'react-toastify';
import { LoginPopup,TweetAtom,EmptyTweet } from '../components/index';
...
function FeedTweets({ owner = false }) {
    ...
    function addTweet(data) {
        ...
        if(!data.tweet.trim()) {
            ...
            toast.error("Minimum 10 charactes are required");
            setFocus("tweet");
            return;
        } else if (data.tweet.trim()?.length > 500) {
            toast.error("Maximum 500 charactes are allowed");
            setFocus("tweet");
            return;
        }
                        ...
                        <span className='flex w-full gap-x-4'>
                            ...
                            <div className='block w-full'>
                                ...
                                <p className='my-1 text-[14px]'>
                                    <span className='text-transparent h-6 bg-slate-100/10 rounded animate-pulse w-[50%] outline-none border-b-[1px] border-transparent'></span>
                                </p>
                            </div>
                        </span>
                    </div>
